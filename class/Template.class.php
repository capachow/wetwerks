					...
					<div class="template-header-top'.(self::isPage('404') ? ' template-header-top-static' : null).'">
							...
							<nav>
								...
								<div class="template-component-menu-default">
									<ul class="sf-menu">
										...
										'.self::createMenuItem('booking','Booking').'
						...
						<div class="template-header-top-icon-list template-component-social-icon-list-1">
							<ul class="template-component-social-icon-list">
								<li><a href="https://facebook.com/wetwerksdetail" class="template-icon-social-facebook" target="_blank"></a></li>
								<li><a href="https://instagram.com/wetwerksdetail" class="template-icon-social-instagram" target="_blank"></a></li>
