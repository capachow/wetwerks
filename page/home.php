					...
					<div class="template-section template-section-padding-1 template-clear-fix template-main">
						...
						<div class="template-layout-33x66 template-clear-fix">
							...
							<div class="template-layout-column-right" style="width: 100%; text-align: center;">
								...
								<!-- Text -->
								<p class="template-padding-reset">Wet Werks Detail, LLC. has been established in TN. We pride ourselves on customer service and building relationships with our clients who in turn become part of our family. Started out as a small auto detailing company has hope to become a full-fledged, full service detailing center.</p>
